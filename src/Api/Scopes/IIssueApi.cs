...
public interface IIssueApi : IApiScope
{
    ...
    public Task<Issue[]> ListAsync(string owner, string repo, string? state = default, string? labels = default, string? q = default, string? type = default, string? milestones = default, DateTimeOffset? since = default, DateTimeOffset? before = default, string? created_by = default, string? assigned_by = default, string? mentioned_by = default, string? sort = default, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues".WithQuery().Param(state).Param(labels).Param(q).Param(type).Param(milestones).Param(since).Param(before).Param(created_by).Param(assigned_by).Param(mentioned_by).Param(sort).Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.IssueArray, cancelToken);
    ...
    public Task<Issue> GetAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Issue, cancelToken);
    ...
    public Task<Issue> CreateAsync(string owner, string repo, CreateIssueOption options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues", options, ApiDataSerializerContext.Default.CreateIssueOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Issue, cancelToken);
    ...
    public Task<Issue> UpdateAsync(string owner, string repo, long index, EditIssueOption options, CancellationToken cancelToken = default)
        => PatchRequest($"repos/{owner}/{repo}/issues/{index}", options, ApiDataSerializerContext.Default.EditIssueOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Issue, cancelToken);
    ...
    public Task DeleteAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<Attachment[]> ListAttachmentsAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/assets", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.AttachmentArray, cancelToken);
    ...
    public Task<Attachment> GetAttachmentAsync(string owner, string repo, long index, long attachment_id, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/assets/{attachment_id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Attachment, cancelToken);
    ...
    public Task<Attachment> CreateAttachmentAsync(string owner, string repo, long index, Stream attachment, string? name = default, DateTimeOffset? updated_at = default, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/assets".WithQuery().Param(name).Param(updated_at), new FormData().File(attachment).AsContent(), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Attachment, cancelToken);
    ...
    public Task<Attachment> UpdateAttachmentAsync(string owner, string repo, long index, long attachment_id, EditAttachmentOptions options, CancellationToken cancelToken = default)
        => PatchRequest($"repos/{owner}/{repo}/issues/{index}/assets/{attachment_id}", options, ApiDataSerializerContext.Default.EditAttachmentOptions, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Attachment, cancelToken);
    ...
    public Task DeleteAttachmentAsync(string owner, string repo, long index, long attachment_id, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/assets/{attachment_id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<Reaction[]> ListReactionsAsync(string owner, string repo, long index, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/reactions".WithQuery().Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.ReactionArray, cancelToken);
    ...
    public Task<Reaction> AddReactionAsync(string owner, string repo, long index, EditReactionOption options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/reactions", options, ApiDataSerializerContext.Default.EditReactionOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Reaction, cancelToken);
    ...
    public Task RemoveReactionAsync(string owner, string repo, long index, EditReactionOption options, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/reactions", options, ApiDataSerializerContext.Default.EditReactionOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<Comment[]> ListRepositoryCommentsAsync(string owner, string repo, DateTimeOffset? since = default, DateTimeOffset? before = default, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/comments".WithQuery().Param(since).Param(before).Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.CommentArray, cancelToken);
    ...
    public Task<Comment[]> ListIssueCommentsAsync(string owner, string repo, long index, DateTimeOffset? since = default, DateTimeOffset? before = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/comments".WithQuery().Param(since).Param(before), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.CommentArray, cancelToken);
    ...
    public Task<Comment?> GetCommentAsync(string owner, string repo, long id, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/comments/{id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Comment, cancelToken);
    ...
    public Task<Comment> CreateCommentAsync(string owner, string repo, long index, CreateIssueCommentOption options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/comments", options, ApiDataSerializerContext.Default.CreateIssueCommentOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Comment, cancelToken);
    ...
    public Task<Comment?> UpdateCommentAsync(string owner, string repo, long id, EditIssueCommentOption options, CancellationToken cancelToken = default)
        => PatchRequest($"repos/{owner}/{repo}/issues/comments/{id}", options, ApiDataSerializerContext.Default.EditIssueCommentOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Comment, cancelToken);
    ...
    public Task DeleteCommentAsync(string owner, string repo, long id, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/comments/{id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<Attachment[]> ListCommentAttachmentsAsync(string owner, string repo, long id, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/comments/{id}/assets", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.AttachmentArray, cancelToken);
    ...
    public Task<Attachment> GetCommentAttachmentAsync(string owner, string repo, long id, long attachment_id, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Attachment, cancelToken);
    ...
    public Task<Attachment> CreateCommentAttachmentAsync(string owner, string repo, long id, Stream attachment, string? name = default, DateTimeOffset? updated_at = default, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/comments/{id}/assets".WithQuery().Param(name).Param(updated_at), new FormData().File(attachment).AsContent(), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Attachment, cancelToken);
    ...
    public Task<Attachment> UpdateCommentAttachmentAsync(string owner, string repo, long id, long attachment_id, EditAttachmentOptions options, CancellationToken cancelToken = default)
        => PatchRequest($"repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id}", options, ApiDataSerializerContext.Default.EditAttachmentOptions, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Attachment, cancelToken);
    ...
    public Task DeleteCommentAttachmentAsync(string owner, string repo, long id, long attachment_id, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<Reaction[]> ListCommentReactionsAsync(string owner, string repo, long id, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/comments/{id}/reactions", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.ReactionArray, cancelToken);
    ...
    public Task<Reaction> AddCommentReactionAsync(string owner, string repo, long id, EditReactionOption options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/comments/{id}/reactions", options, ApiDataSerializerContext.Default.EditReactionOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Reaction, cancelToken);
    ...
    public Task RemoveCommentReactionAsync(string owner, string repo, long id, EditReactionOption options, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/comments/{id}/reactions", options, ApiDataSerializerContext.Default.EditReactionOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<Issue[]> ListBlockedAsync(string owner, string repo, long index, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/blocks".WithQuery().Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.IssueArray, cancelToken);
    ...
    public Task<Issue> BlockAsync(string owner, string repo, long index, IssueMeta options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/blocks", options, ApiDataSerializerContext.Default.IssueMeta, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Issue, cancelToken);
    ...
    public Task<Issue> UnblockAsync(string owner, string repo, long index, IssueMeta options, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/blocks", options, ApiDataSerializerContext.Default.IssueMeta, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Issue, cancelToken);
    #endregion
    ...
    public Task<Issue[]> ListDependenciesAsync(string owner, string repo, long index, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/dependencies".WithQuery().Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.IssueArray, cancelToken);
    ...
    public Task<Issue> MakeDependencyAsync(string owner, string repo, long index, IssueMeta options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/dependencies", options, ApiDataSerializerContext.Default.IssueMeta, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Issue, cancelToken);
    ...
    public Task<Issue> RemoveDependencyAsync(string owner, string repo, long index, IssueMeta options, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/dependencies", options, ApiDataSerializerContext.Default.IssueMeta, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Issue, cancelToken);
    #endregion
    ...
    public Task<IssueDeadline> SetDeadlineAsync(string owner, string repo, long index, EditDeadlineOption options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/deadline", options, ApiDataSerializerContext.Default.EditDeadlineOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.IssueDeadline, cancelToken);
    #endregion
    ...
    public Task<Label[]> ListRepositoryLabelsAsync(string owner, string repo, string? sort = default, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/labels".WithQuery().Param(sort).Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.LabelArray, cancelToken);
    ...
    public Task<Label> GetRepositoryLabelAsync(string owner, string repo, long id, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/labels/{id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Label, cancelToken);
    ...
    public Task<Label> CreateRepositoryLabelAsync(string owner, string repo, CreateLabelOption options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/labels", options, ApiDataSerializerContext.Default.CreateLabelOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Label, cancelToken);
    ...
    public Task<Label> UpdateRepositoryLabelAsync(string owner, string repo, long id, EditLabelOption options, CancellationToken cancelToken = default)
        => PatchRequest($"repos/{owner}/{repo}/labels/{id}", options, ApiDataSerializerContext.Default.EditLabelOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Label, cancelToken);
    ...
    public Task DeleteRepositoryLabelAsync(string owner, string repo, long id, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/labels/{id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<Label[]> ListIssueLabelsAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/labels", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.LabelArray, cancelToken);
    ...
    public Task<Label[]> AddIssueLabelAsync(string owner, string repo, long index, IssueLabelsOption options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/labels", options, ApiDataSerializerContext.Default.IssueLabelsOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.LabelArray, cancelToken);
    ...
    public Task<Label[]> ReplaceIssueLabelsAsync(string owner, string repo, long index, IssueLabelsOption options, CancellationToken cancelToken = default)
        => PutRequest($"repos/{owner}/{repo}/issues/{index}/labels", options, ApiDataSerializerContext.Default.IssueLabelsOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.LabelArray, cancelToken);
    ...
    public Task RemoveIssueLabelAsync(string owner, string repo, long index, string identifier, DeleteLabelsOption options, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/labels/{identifier}", options, ApiDataSerializerContext.Default.DeleteLabelsOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    ...
    public Task ClearIssueLabelsAsync(string owner, string repo, long index, DeleteLabelsOption options, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/labels", options, ApiDataSerializerContext.Default.DeleteLabelsOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task PinAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/pin", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    ...
    public Task UnpinAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/pin", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    ...
    public Task MovePinAsync(string owner, string repo, long index, long position, CancellationToken cancelToken = default)
        => PatchRequest($"repos/{owner}/{repo}/issues/{index}/pin/{position}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task StartStopwatchAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/stopwatch/start", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    ...
    public Task StopStopwatchAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/stopwatch/stop", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    ...
    public Task DeleteStopwatchAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/stopwatch/delete", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<User[]> ListSubscribedUsersAsync(string owner, string repo, long index, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/subscriptions".WithQuery().Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.UserArray, cancelToken);
    ...
    public Task<WatchInfo> IsUserSubscribedAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/subscriptions/check", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.WatchInfo, cancelToken);
    ...
    public Task SubscribeUserAsync(string owner, string repo, long index, string user, CancellationToken cancelToken = default)
        => PutRequest($"repos/{owner}/{repo}/issues/{index}/subscriptions/{user}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    ...
    public Task UnsubscribeUserAsync(string owner, string repo, long index, string user, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/subscriptions/{user}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<TimelineComment[]> ListTimelineAsync(string owner, string repo, long index, DateTimeOffset? since = default, DateTimeOffset? before = default, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/timeline".WithQuery().Param(since).Param(before).Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.TimelineCommentArray, cancelToken);
    #endregion
    ...
    public Task<TrackedTime[]> ListTrackedTimesAsync(string owner, string repo, long index, string? user = default, DateTimeOffset? since = default, DateTimeOffset? before = default, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/issues/{index}/times".WithQuery().Param(user).Param(since).Param(before).Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.TrackedTimeArray, cancelToken);
    ...
    public Task<TrackedTime> AddTrackedTimeAsync(string owner, string repo, long index, AddTimeOption options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/issues/{index}/times", options, ApiDataSerializerContext.Default.AddTimeOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.TrackedTime, cancelToken);
    ...
    public Task ResetTrackedTimeAsync(string owner, string repo, long index, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/times", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    ...
    public Task DeleteTrackedTimeAsync(string owner, string repo, long index, long id, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/issues/{index}/times/{id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion
    ...
    public Task<Milestone[]> ListMilestonesAsync(string owner, string repo, string? state = default, string? name = default, PagingOptions paging = default, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/milestones".WithQuery().Param(state).Param(name).Param(paging), cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.MilestoneArray, cancelToken);
    ...
    public Task<Milestone> GetMilestoneAsync(string owner, string repo, long id, CancellationToken cancelToken = default)
        => GetRequest($"repos/{owner}/{repo}/milestones/{id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Milestone, cancelToken);
    ...
    public Task<Milestone> CreateMilestoneAsync(string owner, string repo, CreateMilestoneOption options, CancellationToken cancelToken = default)
        => PostRequest($"repos/{owner}/{repo}/milestones", options, ApiDataSerializerContext.Default.CreateMilestoneOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Milestone, cancelToken);
    ...
    public Task<Milestone> UpdateMilestoneAsync(string owner, string repo, long id, EditMilestoneOption options, CancellationToken cancelToken = default)
        => PatchRequest($"repos/{owner}/{repo}/milestones/{id}", options, ApiDataSerializerContext.Default.EditMilestoneOption, cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.Milestone, cancelToken);
    ...
    public Task DeleteMilestoneAsync(string owner, string repo, long id, CancellationToken cancelToken = default)
        => DeleteRequest($"repos/{owner}/{repo}/milestones/{id}", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.EmptyResult, cancelToken);
    #endregion

...
public interface ISettingsApi : IApiScope
{
    ...
    public Task<GeneralAPISettings> GetApiSettingsAsync(CancellationToken cancelToken = default)
        => GetRequest("settings/api", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.GeneralAPISettings, cancelToken);
    ...
    public Task<GeneralAttachmentSettings> GetAttachmentSettingsAsync(CancellationToken cancelToken = default)
        => GetRequest("settings/attachment", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.GeneralAttachmentSettings, cancelToken);
    ...
    public Task<GeneralRepoSettings> GetRepositorySettingsAsync(CancellationToken cancelToken = default)
        => GetRequest("settings/repository", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.GeneralRepoSettings, cancelToken);
    ...
    public Task<GeneralUISettings> GetUiSettingsAsync(CancellationToken cancelToken = default)
        => GetRequest("settings/ui", cancelToken).JsonResponseAsync(ApiDataSerializerContext.Default.GeneralUISettings, cancelToken);
